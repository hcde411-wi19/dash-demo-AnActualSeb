    ...
    dcc.Graph(
        ...
        figure={
            ...
            'data': [
                ...
                {'x': weekday_in_order, 'y': ped_s, 'type': 'bar', 'name': 'Pedestrians South'},
                {'x': weekday_in_order, 'y': ped_n, 'type': 'bar', 'name': 'Pedestrians North'},
                {'x': weekday_in_order, 'y': bike_s, 'type': 'bar', 'name': 'Bikes South'},
                {'x': weekday_in_order, 'y': bike_n, 'type': 'bar', 'name': 'Bikes North'},
